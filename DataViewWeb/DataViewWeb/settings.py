"""
Django settings for DataViewWeb project.
...
WSGI_APPLICATION = 'DataViewWeb.wsgi.application'
...
# DATABASE_ROUTERS = ['TrafficView.models.AuthRouter']
# Password validation
